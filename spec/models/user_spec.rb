...
describe User do
  ...
  it "should accept valid email addressees" do
  ...
  it "should reject identical email" do
    # Put user with a valid email address into the database
    User.create!(@attr)
    user_with_duplicate_email = User.new(@attr)
    user_with_duplicate_email.should_not be_valid
  end

  it "should reject identical email up to upcase" do
    # Put user with a valid email address into the database
  ...
  describe "password encryption"
    ...
    before(:each) do
      @user = User.create!(@attr.merge(:email => "test_encryption@example.com"))
    end
    ...
    it "should return the user on email/password match" do
      ...
      matching_user = User.authenticate(@user.email, @attr[:password])
